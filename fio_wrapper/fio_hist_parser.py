...
def compute_percentiles_from_logs(output_csv_file, file_list, fio_version=3, bucket_groups=29, bucket_bits=6, pctiles_wanted=[ 0., 50., 95., 99., 100.], time_quantum=1, log_hist_msec=None, output_unit="usec", output_csv_file_header=False):
    ...
    for fn in file_list:
        try:
            (hist_files[fn], log_start_time, log_end_time)  = parse_hist_file(fn, buckets_per_interval, log_hist_msec)
