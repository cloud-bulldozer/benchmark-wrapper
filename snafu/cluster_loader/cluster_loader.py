...
class cluster_loader_wrapper:
    def __init__(self, parser):
        ...
        parser.add_argument("--cl-output", help="print the cl output to console ( helps with CI )", type=bool)
        parser.add_argument(dest="test_name", help="name of the test", type=str, metavar="test_name")
