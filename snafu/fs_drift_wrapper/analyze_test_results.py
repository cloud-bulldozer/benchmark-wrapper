...
for hit in hit_generator:
    ...
    if debug: print(json.dumps(src, indent=2))
...
for s in sorted(sample_list_keys):
        ...
        print('%2d, %-40s, %3s, %d, %f, %f, %f, %f, %f' % 
                (s, 'all-pods', 'all-threads', total_files, total_files_per_sec, total_MiB_per_sec, total_iops, mean_elapsed, pctdev))
...
print('mean fps %f, %% dev fps %f' % (fps_mean_across_samples, fps_pctdev_across_samples))
