...
print(
    "   optype, sample, pod,                            thread, files, files/sec, MiB/s, IOPS, elapsed, %dev"
)
for optype in sorted(optype_dict.keys()):
    ...
    print("%10s, mean fps %f, %% dev fps %f" % (optype, fps_mean_across_samples, fps_pctdev_across_samples))
